                ...
                <x-form.wrapper action="{{ route('admin.study-abroads.store') }}" method="POST"
                    ...
                    <x-form.row>
                        <x-form.input type="file" label="Image" col="6" name="image" alt="image"
                            helperText="Accepted: PNG, JPG, JPEG, SVG, WEBP, GIF. Max size: 5MB. No fixed dimensions are enforced; use a clear high-resolution image."
                    ...
                    @php
                        $oldQuickInfos = old('quick_info_items', [['icon' => 'bi bi-globe', 'title' => '', 'value' => '']]);
                    @endphp
