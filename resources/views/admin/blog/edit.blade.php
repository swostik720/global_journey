        ...
        <div class="card">
            <div class="card-body">
                <x-form.wrapper action="{{ route('admin.blogs.update', $blog->id) }}" method="POST"
                    ...
                    <x-form.row>
                        <x-form.select label="Author" :col="6" :req="true" :model="$blog->blog_author_id"
                            :options="$authors" name="blog_author_id"></x-form.select>
                    ...
                    @php
                        $quickInfos = old('quick_info_items', $blog->quick_info_items ?? [['icon' => 'bi bi-info-circle', 'title' => '', 'value' => '']]);
                    @endphp
                    ...
                    @php
                        $highlights = old('key_highlights', $blog->key_highlights ?? [['text' => '']]);
                    @endphp
