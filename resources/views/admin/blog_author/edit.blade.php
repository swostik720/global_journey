        ...
        <div class="card">
            <div class="card-body">
                <x-form.wrapper action="{{ route('admin.blog-authors.update', $author->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <x-form.row>
                        <x-form.input type="text" label="Profile Picture Alt Text" id="profile_picture_alt" name="profile_picture_alt" value="{{ old('profile_picture_alt', $author->profile_picture_alt) }}" col="12" helperText="Describe the author profile picture for accessibility and SEO." />
                    </x-form.row>
