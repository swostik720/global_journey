        ...
        <div class="row">
            ...
            <div class="offset-xl-1 col-xl-5">
                <div class="team-welcome-text">
                    <p>Our team is always ready to work with exciting and ambitious clients. If you're ready to start your creative partnership with us, get in touch.</p>
        ...
        <div class="row">
            <div class="col-xl-3 col-md-6 col-sm-12">
                <div class="makes-us-different-text">
                    ...
                    <p>
                        Our team is dedicated to guiding students toward their academic goals with personalized support. We understand the importance of each student’s journey and focus on providing tailored advice to help them succeed in their chosen fields.
            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                <div class="makes-us-different-text">
                    ...
                    <p>
                        Our consultancy boasts a proven track record of helping students secure placements in top universities and programs worldwide. We offer comprehensive guidance, ensuring every student maximizes their chances of success.
            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                <div class="makes-us-different-text">
                    ...
                    <p>
                        With a focus on achieving tangible results, we assist students in navigating their educational pathways by providing clear, actionable plans. Our step-by-step approach helps students reach their full potential, making informed decisions at every stage.
                    </p>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 col-sm-12">
                <div class="makes-us-different-text">
                    ...
                    <h4>Trustworthy</h4>
                    <p>
                        With a commitment to transparency and reliability, our consultancy is a trusted partner for students and their families. We provide honest advice and support throughout the entire application process, ensuring peace of mind and confidence in achieving academic goals.
                    </p>
                </div>
            </div>
        </div>
